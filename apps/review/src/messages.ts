...
export const m = {
  ...
  finish_confirm_title: () => "Finish this review?",
  finish_confirm_clean: () => "Everything in the review queue has been handled.",
  finish_confirm_incomplete: (p: { count: number }) =>
    `${p.count} finding(s) still need a decision. You can finish now and return later, but this review is incomplete.`,
  finish_confirm_action: () => "Finish and close",
  finish_error: () => "Could not finish the review. The server is still running; try again.",
  ...
  guided_mark_reviewed: () => "Skip for this session",
  guided_reviewed: () => "Handled this session",
