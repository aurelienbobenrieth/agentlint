 ...
 *
 * Builds a dispatch table from all active rules' visitor methods, walks the tree once using tree-sitter's cursor API,
 * and calls all matching handlers per node.
 *
 * @module
 */
