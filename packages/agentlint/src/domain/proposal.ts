 ...
 *
 * A proposal never opens a gate. It records what an agent did or suggests for a finding it cannot accept itself, so the
 * human reviewer sees the agent's work next to the evidence instead of rediscovering it.
 *
 * @module
 * @since 0.2.0
 */
